...
const createUser = async (userData)=> {
	const { firstName, lastName, email, password, gender, jobRole, department, address } = userData;

	const id = new UUID();
	userDataArray = [ id, firstName, lastName, email, password, gender, jobRole, department, address ];
